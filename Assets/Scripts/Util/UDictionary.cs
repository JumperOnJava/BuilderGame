...
//Цей клас - розширює можливості словника для його сумісності з юніті
//Це необхідно для того щоб юніті зміг зберігати його дані в свій формат 
//Також таким чином дані цього словника можна редагувати через редактор в юніті

//Словник (Асоціативний масив, Карта (англ. Map))- вид масиву який допомагає отримувати його елементи не по індексу, а по іншому об'єкту
